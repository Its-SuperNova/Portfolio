...
export const projects: Project[] = [
  ...
  {
    id: 5,
    url: "duchess-pastry-app",
    title: "Duchess Pastry Delivery",
    tags: [
      "Next.js",
      "React",
      "TailwindCSS",
    ...
    category: "Full Stack",
    image: "/images/project/duchess-pastry.png",
    link: "/works/duchess-pastry-app",
    description:
      "A full‑stack online ordering and delivery platform for Duchess Pastry. Customers can browse categories of freshly‑baked treats, place orders with one‑click Google login, and track delivery status in real time. The admin panel provides secure CRUD management of products, categories, coupons, users and orders, all updated instantly.",
    technologies: [
      "Next.js",
      "React",
      "TailwindCSS",
    ...
    sourceCode: "https://github.com/YourUsername/duchess-pastry-app",
    livePreview: "https://duchesspastry.com",
    whyIBuiltThis: {
      description:
        "I created this delivery app to give Duchess Pastry a scalable, modern web presence that drives online orders and streamlines their internal operations. It showcases real‑time features, seamless authentication, and an intuitive admin dashboard—all deployed on Vercel for blazing‑fast performance.",
      cards: [
        {
          title: "Enhanced Customer Experience",
          description:
            "Built a smooth ordering flow with instant Google sign‑in and live map tracking to delight pastry lovers.",
          bgColor: "#fffaf0",
          textColor: "#d2691e",
        },
        {
          ...
          description:
            "Delivered a powerful admin panel with real‑time CRUD and analytics, so the Duchess team can manage inventory, orders and promotions effortlessly.",
          bgColor: "#f0fff0",
          textColor: "#228b22",
        },
      ],
    ...
    whatILearned: [
      {
        ...
        description:
          "Integrated Google Maps API for real‑time order tracking and mapped delivery routes.",
      },
      {
        title: "Secure OAuth Flows",
        description:
          "Configured Auth.js with Google provider to streamline user authentication and session management.",
      },
      {
        title: "Scalable Data Modeling",
        description:
          "Designed Prisma schemas on PostgreSQL for products, orders, users and coupons, with efficient indexing.",
      },
      {
        title: "CI/CD & Edge Functions",
        description:
          "Deployed to Vercel with automated builds and leveraged Next.js edge functions for low‑latency responses.",
      },
    ],
    designPrinciples: [
      {
        title: "Intuitive Ordering",
        description:
          "Clear category hierarchy and product cards, plus one‑click login for frictionless checkout.",
        icon: "/svg/design-priciple/user-experience.svg",
        iconColor: "#00bcd4",
      },
      {
        ...
        description:
          "Live order status updates and animated map markers keep users informed every step of the way.",
        icon: "/svg/design-priciple/animation.svg",
        iconColor: "#f44336",
      },
      {
        ...
        description:
          "Mobile‑first layouts with proper ARIA labels ensure every customer can order on any device.",
        icon: "/svg/design-priciple/accessibility.svg",
        iconColor: "#607d8b",
      },
      {
        title: "Clean Admin UX",
        description:
          "Dashboard widgets and real‑time CRUD actions let staff manage products, users and coupons without friction.",
        icon: "/svg/design-priciple/minimalism.svg",
        iconColor: "#9c27b0",
      },
      {
        ...
        description:
          "Tailwind utility classes, image optimization and edge caching deliver fast load times under any network conditions.",
        icon: "/svg/design-priciple/performance.svg",
        iconColor: "#ff9800",
      },
    ],
